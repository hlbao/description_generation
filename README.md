...
3. This repository included two parts, the first is a Wikipedia crawler. The output should be named with 'wikiextractor/extracted/originaltext', and stored within the same root-folder. 
